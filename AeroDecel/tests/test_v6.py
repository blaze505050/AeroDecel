...
class TestRealGasChemistry:
    ...
    def test_gamma_decreases_with_dissociation(self):
        from src.realgas_chemistry import equilibrium_composition, mixture_gamma
        g1 = mixture_gamma(equilibrium_composition(1000, 1e5), 1000)
        g2 = mixture_gamma(equilibrium_composition(5000, 1000), 5000)
        assert g2 < g1, f"γ should decrease: g1={g1:.3f} g2={g2:.3f}"
